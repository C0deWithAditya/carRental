    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_quarter first"> 
          <!-- ################################################################################################ -->
          <ul class="nospace">
            <li class="btmspace-15"><a href="#"><em class="heading">MANAGE CUSTOMERS</em> 
		<img class="borderedbox" src="images/demo/slider/1.png" alt=""></a></li>
            <li class="btmspace-15"><a href="#"><em class="heading">MANAGE ACCOUNTS</em> 
		<img class="borderedbox" src="images/demo/slider/2.png" alt=""></a></li>
            <li class="btmspace-15"><a href="#"><em class="heading">MANAGE ORDERS</em> 
		<img class="borderedbox" src="images/demo/slider/3.jpg" alt=""></a></li>
            <li><a href="#"><em class="heading">MANAGE TRANSACTIONS</em> 
		<img class="borderedbox" src="images/demo/slider/4.jpg" alt=""></a></li>
          </ul>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Left Column --> 
        ...
        <div class="one_half" style="width:70%"> 
          <!-- ################################################################################################ -->
          <h2>ONLINE TAXI BOOKING SYSTEM</h2>
          <ul class="nospace listing">
            <li class="clear">
              <div class="imgl borderedbox"><img src="images/demo/main2.jpg" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">CUSTOMER MANAGEMENT SYSTEM</a></p>
            ...
            <li class="clear">
              <div class="imgl borderedbox"><img src="images/demo/main1.png" alt=""></div>
            ...
            <li class="clear">
              ...
              <p class="nospace btmspace-15"><a href="#">CAR MANAGEMENT SYSTEM</a></p>
