...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
      <div id="comments" style="color:#000000">
      <h2>Introduction of Car Rental System</h2>
	<p>
