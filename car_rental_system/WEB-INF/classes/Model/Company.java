...
public class Company extends Connect
{
	...
	{
		String SQL = "INSERT INTO `company` (`company_name`, `company_description`) VALUES (?, ?);";
		int record=0; 
		String error = "";
		...
		try
		{
			...
			pstmt.setString(2,(String) companyData.get("company_description"));
	...
	{
		String SQL = "UPDATE `company` SET `company_name` = ?, `company_description` = ? WHERE `company_id` = ?;";
		String error = "";
		...
		try
		{
			...
			pstmt.setString(1,(String) companyData.get("company_name"));
			pstmt.setString(2,(String) companyData.get("company_description"));
			pstmt.setString(3,(String) companyData.get("company_id"));
