...
public class CarType extends Connect
{
	...
	//////////Save User Details /////
	public String saveCarType(HashMap typeData)
	{
    ...
    public HashMap getCarTypeDetails(int type_id)
	{
    ...
    /// Update the CarType ////
	public String updateCarType(HashMap typeData)
	{
    ...
    public ArrayList getAllCarType()
	{
