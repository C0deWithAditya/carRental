...
tr {
	border-bottom:1px solid #175c6f;
}
  ...
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
        ...
        <div>
			<div style="float:left; border:3px solid #175c6f; padding:1px; border-radius:3px;"><img src="carImages/<% out.print(Values.get("car_image")); %>" style="height:320px; width:300px;"></div>
